...
> implements ReactiveController
{
     ...
     */
    whenQueryObserver = (Promise as unknown as PromiseWithResolvers).withResolvers<
    ...
    constructor(
        ...
        console.log('init context ', this.context)

        // Observe the query if a query function is provided
        if (this.optionsFn) {
            console.log('observing query with options fn! ')
    ...
    async observeQuery(
        ...
        console.log('waiting for query client')
