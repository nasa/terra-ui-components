...
describe('<gd-radio-group>', () => {
  describe('validation tests', () => {
    it('should be invalid initially when required and no radio is checked', async () => {
      const radioGroup = await fixture<SlRadioGroup>(html`
        <gd-radio-group required>
          <gd-radio value="1"></gd-radio>
          <gd-radio value="2"></gd-radio>
        </gd-radio-group>
      `);
    ...
    it(`should be valid when required and one radio is checked`, async () => {
      const el = await fixture<SlRadioGroup>(html`
        <gd-radio-group label="Select an option" value="1" required>
          <gd-radio name="option" value="1">Option 1</gd-radio>
          <gd-radio name="option" value="2">Option 2</gd-radio>
          <gd-radio name="option" value="3">Option 3</gd-radio>
        </gd-radio-group>
      `);
    ...
    it(`should be invalid when required and no radios are checked`, async () => {
      const el = await fixture<SlRadioGroup>(html`
        <gd-radio-group label="Select an option" required>
          <gd-radio name="option" value="1">Option 1</gd-radio>
          <gd-radio name="option" value="2">Option 2</gd-radio>
          <gd-radio name="option" value="3">Option 3</gd-radio>
        </gd-radio-group>
    ...
    it(`should be valid when required and a different radio is checked`, async () => {
      const el = await fixture<SlRadioGroup>(html`
        <gd-radio-group label="Select an option" value="3" required>
          <gd-radio name="option" value="1">Option 1</gd-radio>
          <gd-radio name="option" value="2">Option 2</gd-radio>
          <gd-radio name="option" value="3">Option 3</gd-radio>
        </gd-radio-group>
    ...
    it(`should be invalid when custom validity is set`, async () => {
      const el = await fixture<SlRadioGroup>(html`
        <gd-radio-group label="Select an option">
          <gd-radio name="option" value="1">Option 1</gd-radio>
          <gd-radio name="option" value="2">Option 2</gd-radio>
          <gd-radio name="option" value="3">Option 3</gd-radio>
        </gd-radio-group>
    ...
    it('should receive the correct validation attributes ("states") when valid', async () => {
      const radioGroup = await fixture<SlRadioGroup>(html`
        <gd-radio-group value="1" required>
          <gd-radio value="1"></gd-radio>
          <gd-radio value="2"></gd-radio>
        </gd-radio-group>
      `);
      const secondRadio = radioGroup.querySelectorAll('gd-radio')[1];
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      ...
      `);
      const radioGroup = el.querySelector<SlRadioGroup>('gd-radio-group')!;
      ...
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <gd-radio-group value="1">
            <gd-radio id="radio-1" name="a" value="1"></gd-radio>
            <gd-radio id="radio-2" name="a" value="2"></gd-radio>
          </gd-radio-group>
          <gd-button type="submit">Submit</gd-button>
        </form>
      `);
      const button = form.querySelector('gd-button')!;
      const radioGroup = form.querySelector<SlRadioGroup>('gd-radio-group')!;
...
describe('when submitting a form', () => {
  it('should submit the correct value when a value is provided', async () => {
    const form = await fixture<HTMLFormElement>(html`
      <form>
        <gd-radio-group name="a" value="1">
          <gd-radio id="radio-1" value="1"></gd-radio>
          <gd-radio id="radio-2" value="2"></gd-radio>
          <gd-radio id="radio-3" value="3"></gd-radio>
        </gd-radio-group>
        <gd-button type="submit">Submit</gd-button>
      </form>
    `);
    const button = form.querySelector('gd-button')!;
    const radio = form.querySelectorAll('gd-radio')[1]!;
  ...
  it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
    const el = await fixture<HTMLFormElement>(html`
      <div>
        ...
        <gd-radio-group form="f" name="a" value="1">
          <gd-radio id="radio-1" value="1"></gd-radio>
          <gd-radio id="radio-2" value="2"></gd-radio>
          <gd-radio id="radio-3" value="3"></gd-radio>
        </gd-radio-group>
...
describe('when a size is applied', () => {
  it('should apply the same size to all radios', async () => {
    const radioGroup = await fixture<SlRadioGroup>(html`
      <gd-radio-group size="large">
        <gd-radio id="radio-1" value="1"></gd-radio>
        <gd-radio id="radio-2" value="2"></gd-radio>
      </gd-radio-group>
    `);
    const [radio1, radio2] = radioGroup.querySelectorAll('gd-radio')!;
  ...
  it('should apply the same size to all radio buttons', async () => {
    const radioGroup = await fixture<SlRadioGroup>(html`
      <gd-radio-group size="large">
        <gd-radio-button id="radio-1" value="1"></gd-radio-button>
        <gd-radio-button id="radio-2" value="2"></gd-radio-button>
      </gd-radio-group>
    `);
    const [radio1, radio2] = radioGroup.querySelectorAll('gd-radio-button')!;
...
describe('when the value changes', () => {
  it('should emit gd-change when toggled with the arrow keys', async () => {
    const radioGroup = await fixture<SlRadioGroup>(html`
      <gd-radio-group>
        <gd-radio id="radio-1" value="1"></gd-radio>
        <gd-radio id="radio-2" value="2"></gd-radio>
    ...
    radioGroup.addEventListener('gd-change', changeHandler);
    radioGroup.addEventListener('gd-input', inputHandler);
    firstRadio.focus();
  ...
  it('should emit gd-change and gd-input when clicked', async () => {
    const radioGroup = await fixture<SlRadioGroup>(html`
      <gd-radio-group>
        <gd-radio id="radio-1" value="1"></gd-radio>
        <gd-radio id="radio-2" value="2"></gd-radio>
    ...
    const event = (await oneEvent(radioGroup, 'gd-change')) as SlChangeEvent;
    expect(event.target).to.equal(radioGroup);
    expect(radioGroup.value).to.equal('1');
  });

  it('should emit gd-change and gd-input when toggled with spacebar', async () => {
    const radioGroup = await fixture<SlRadioGroup>(html`
      <gd-radio-group>
        <gd-radio id="radio-1" value="1"></gd-radio>
        <gd-radio id="radio-2" value="2"></gd-radio>
  ...
  it('should not emit gd-change or gd-input when the value is changed programmatically', async () => {
    ...
    radioGroup.addEventListener('gd-change', () => expect.fail('gd-change should not be emitted'));
    radioGroup.addEventListener('gd-input', () => expect.fail('gd-input should not be emitted'));
    radioGroup.value = '2';
    await radioGroup.updateComplete;
  });
  ...
  it('should relatively position content to prevent visually hidden scroll bugs', async () => {
    //
    // See https://github.com/gesdisc/components/issues/1380
    //
    const radioGroup = await fixture<SlRadioGroup>(html`
      <gd-radio-group value="1">
        <gd-radio id="radio-1" value="1"></gd-radio>
  ...
  /**
   * @see https://github.com/gesdisc/components/issues/1361
  ...
  it.skip('should sync up radios and radio buttons if defined after radio group', async () => {
    // customElements.define("gd-radio-group", SlRadioGroup)
    //
    // const radioGroup = await fixture<SlRadioGroup>(html`
    //   <gd-radio-group value="1">
    //     <gd-radio id="radio-1" value="1"></gd-radio>
    ...
    // await aTimeout(1)
    //
    // customElements.define("gd-radio-button", SlRadioButton)
    //
    // expect(radioGroup.querySelector("gd-radio")?.getAttribute("aria-checked")).to.equal("false")
    //
    // await aTimeout(1)
    //
    // customElements.define("gd-radio", SlRadio)
    //
    // await aTimeout(1)
    //
    // expect(radioGroup.querySelector("gd-radio")?.getAttribute("aria-checked")).to.equal("true")
  });

  runFormControlBaseTests('gd-radio-group');
});
