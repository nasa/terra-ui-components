...
describe('<gd-progress-ring>', () => {
  let el: SlProgressRing;

  describe('when provided just a value parameter', () => {
    before(async () => {
      el = await fixture<SlProgressRing>(html`<gd-progress-ring value="25"></gd-progress-ring>`);
    });
  ...
  describe('when provided a title, and value parameter', () => {
    ...
    before(async () => {
      el = await fixture<SlProgressRing>(
        html`<gd-progress-ring title="Titled Progress Ring" value="25"></gd-progress-ring>`
      );
  ...
  describe('when provided a ariaLabel, and value parameter', () => {
    before(async () => {
      el = await fixture<SlProgressRing>(
        html`<gd-progress-ring ariaLabel="Labelled Progress Ring" value="25"></gd-progress-ring>`
      );
    });
  ...
  describe('when provided a ariaLabelledBy, and value parameter', () => {
    before(async () => {
      el = await fixture<SlProgressRing>(html`
        ...
        <gd-progress-ring ariaLabelledBy="labelledby" value="25"></gd-progress-ring>
      `);
    });
