 ...
 *
 * All EDUX components must use the system library instead of the default library. For visual consistency, system
 * icons are pulled from the Horizon Design System.
 */

const systemIcons = {
    'arrow-down-circle': `
    <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor">
      <path d="M250.168 440.099c-104.896 0-189.932-85.035-189.932-189.931 0-104.896 85.036-189.931 189.932-189.931 104.894 0 189.931 85.035 189.931 189.931 0 104.896-85.037 189.931-189.931 189.931Zm-13.879-305.996v182.855l-59.541-55.769-19.401 18.161 92.819 86.883 92.84-86.883-19.422-18.161-59.564 55.769V134.103h-27.731Z"/>
    </svg>
    `,
    'arrow-left-circle': `
    <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor">
      <path d="M60.237 250.168c0-104.896 85.035-189.932 189.931-189.932 104.896 0 189.931 85.036 189.931 189.932 0 104.894-85.035 189.931-189.931 189.931-104.896 0-189.931-85.037-189.931-189.931Zm305.996-13.879H183.378l55.769-59.541-18.161-19.401-86.883 92.819 86.883 92.84 18.161-19.422-55.769-59.564h182.855v-27.731Z"/>
    </svg>
    `,
    'arrow-right-circle': `
    <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor">
      <path d="M440.098 250.167c0 104.896-85.035 189.932-189.931 189.932-104.896 0-189.931-85.036-189.931-189.932 0-104.894 85.035-189.931 189.931-189.931 104.896 0 189.931 85.037 189.931 189.931Zm-305.996 13.879h182.855l-55.769 59.541 18.161 19.401 86.883-92.819-86.883-92.84-18.161 19.422 55.769 59.564H134.102v27.731Z"/>
    </svg>
    `,
    'arrow-up-circle': `
    <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor">
      <path d="M250.168 60.237c104.896 0 189.932 85.035 189.932 189.931 0 104.896-85.036 189.931-189.932 189.931-104.894 0-189.931-85.035-189.931-189.931 0-104.896 85.037-189.931 189.931-189.931Zm13.879 305.996V183.378l59.541 55.769 19.401-18.161-92.819-86.883-92.84 86.883 19.422 18.161 59.564-55.769v182.855h27.731Z"/>
    </svg>
    `,

    'chevron-down': `
    <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor">
      <path d="M59.992 173.996 250 364.005l190.009-190.009-38.003-38.001L250 288.002 97.994 135.995l-38.002 38.001Z"/>
    </svg>
  `,
    'chevron-left': `
    <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor">
      <path d="M326.004 59.992 135.995 250l190.009 190.009 38.001-38.003L211.998 250 364.005 97.994l-38.001-38.002Z"/>
    </svg>
  `,
    'chevron-right': `
    <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor">
      <path d="m173.997 440.009 190.009-190.008L173.997 59.992l-38.001 38.003 152.007 152.006-152.007 152.006 38.001 38.002Z"/>
    </svg>
  `,
    'chevron-up': `
    <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor">
      <path d="M440.008 326.004 250 135.995 59.991 326.004l38.003 38.001L250 211.998l152.006 152.007 38.002-38.001Z"/>
    </svg>
    `,
...
//* Use this to references existing icons by a different name.
const aliasedIcons = {
    caret: systemIcons['chevron-up'],
    'caret-circle': systemIcons['chevron-up-circle'],
}

//* If there's a naming conflict, systemIcons should win.
const icons = Object.assign(aliasedIcons, systemIcons)
