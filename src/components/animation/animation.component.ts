 ...
 * @documentation https://disc.gsfc.nasa.gov/components/animation
 * @status stable
 * @since 2.0
 *
 * @event gd-cancel - Emitted when the animation is canceled.
 * @event gd-finish - Emitted when the animation finishes.
 * @event gd-start - Emitted when the animation starts or restarts.
 *
 * @slot - The element to animate. Avoid slotting in more than one element, as subsequent ones will be ignored. To
 *  animate multiple elements, either wrap them in a single container or use multiple `<gd-animation>` elements.
 */
export default class SlAnimation extends GDElement {
