...
import { getFormControls, serialize } from '../../../dist/gesdisc-components.js';
...
describe('<gd-input>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<SlInput>(html` <gd-input label="Name"></gd-input> `);
    await expect(el).to.be.accessible();
  });

  it('default properties', async () => {
    const el = await fixture<SlInput>(html` <gd-input></gd-input> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<SlInput>(html` <gd-input title="Test"></gd-input> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<SlInput>(html` <gd-input disabled></gd-input> `);
    const input = el.shadowRoot!.querySelector<HTMLInputElement>('[part~="input"]')!;
  ...
  describe('value methods', () => {
    it('should set the value as a date when using valueAsDate', async () => {
      const el = document.createElement(`gd-input`);
      el.type = 'date';
  ...
  describe('when using constraint validation', () => {
    ...
    it('should be invalid when required and empty', async () => {
      const el = await fixture<SlInput>(html` <gd-input required></gd-input> `);
      expect(el.reportValidity()).to.be.false;
      expect(el.checkValidity()).to.be.false;
    });

    it('should be invalid when required and disabled is removed', async () => {
      const el = await fixture<SlInput>(html` <gd-input disabled required></gd-input> `);
      el.disabled = false;
    ...
    it('should receive the correct validation attributes ("states") when valid', async () => {
      const el = await fixture<SlInput>(html` <gd-input required value="a"></gd-input> `);
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      const el = await fixture<HTMLFormElement>(html` <form novalidate><gd-input required></gd-input></form> `);
      const input = el.querySelector<SlInput>('gd-input')!;
  ...
  describe('when submitting a form', () => {
    it('should serialize its name and value with FormData', async () => {
      const form = await fixture<HTMLFormElement>(html` <form><gd-input name="a" value="1"></gd-input></form> `);
    ...
    it('should submit the form when pressing enter in a form without a submit button', async () => {
      const form = await fixture<HTMLFormElement>(html` <form><gd-input></gd-input></form> `);
      const input = form.querySelector('gd-input')!;
    ...
    it('should be invalid when setCustomValidity() is called with a non-empty value', async () => {
      const input = await fixture<HTMLFormElement>(html` <gd-input></gd-input> `);
    ...
    it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <gd-input form="f" name="a" value="1"></gd-input>
        </div>
      `);
  ...
  describe('when resetting a form', () => {
    it('should reset the element to its initial value', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <gd-input name="a" value="test"></gd-input>
  ...
  describe('when calling HTMLFormElement.reportValidity()', () => {
    it('should be invalid when the input is empty and form.reportValidity() is called', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <gd-input required value=""></gd-input>
          <gd-button type="submit">Submit</gd-button>
        </form>
      `);
  ...
  describe('when the value changes', () => {
    it('should emit gd-change and gd-input when the user types in the input', async () => {
      const el = await fixture<SlInput>(html` <gd-input></gd-input> `);
    ...
    it('should not emit gd-change or gd-input when the value is set programmatically', async () => {
      const el = await fixture<SlInput>(html` <gd-input></gd-input> `);
    ...
    it('should not emit gd-change or gd-input when calling setRangeText()', async () => {
      const el = await fixture<SlInput>(html` <gd-input value="hi there"></gd-input> `);
  ...
  describe('when type="number"', () => {
    it('should be valid when the value is within the boundary of a step', async () => {
      const el = await fixture<SlInput>(html` <gd-input type="number" step=".5" value="1.5"></gd-input> `);
      expect(el.checkValidity()).to.be.true;
    });

    it('should be invalid when the value is not within the boundary of a step', async () => {
      const el = await fixture<SlInput>(html` <gd-input type="number" step=".5" value="1.25"></gd-input> `);
      expect(el.checkValidity()).to.be.false;
    });
    ...
    it('should increment by step when stepUp() is called', async () => {
      const el = await fixture<SlInput>(html` <gd-input type="number" step="2" value="2"></gd-input> `);
    ...
    it('should not emit gd-input or gd-change when stepUp() is called programmatically', async () => {
      const el = await fixture<SlInput>(html` <gd-input type="number" step="2" value="2"></gd-input> `);
    ...
    it('should not emit gd-input and gd-change when stepDown() is called programmatically', async () => {
      const el = await fixture<SlInput>(html` <gd-input type="number" step="2" value="2"></gd-input> `);
  ...
  describe('when using spellcheck', () => {
    ...
    it('should enable spellcheck when set to "true"', async () => {
      const el = await fixture<SlInput>(html` <gd-input spellcheck="true"></gd-input> `);
      const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
      expect(input.getAttribute('spellcheck')).to.equal('true');
      expect(input.spellcheck).to.be.true;
    });
    ...
    it('should disable spellcheck when set to "false"', async () => {
      const el = await fixture<SlInput>(html` <gd-input spellcheck="false"></gd-input> `);
      const input = el.shadowRoot!.querySelector<HTMLInputElement>('input')!;
    ...
    it('should submit with the correct form when the form attribute changes', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <gd-input form="f1" name="a" value="1"></gd-input>
        </div>
      `);
    ...
    it('should return both native and Shoelace form controls in the correct DOM order', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <gd-input type="text" name="b" value="2" form="f1"></gd-input>
          <form id="f1">
            <input type="hidden" name="c" value="3" />
            <input type="text" name="d" value="4" />
            <gd-input name="e" value="5"></gd-input>
            <textarea name="f">6</textarea>
            <gd-textarea name="g" value="7"></gd-textarea>
            <gd-checkbox name="h" value="8"></gd-checkbox>
          </form>
          <input type="text" name="i" value="9" form="f1" />
          <gd-input type="text" name="j" value="10" form="f1"></gd-input>
        </div>
      `);
  ...
  describe('when using the setRangeText() function', () => {
    it('should set replacement text in the correct location', async () => {
      const el = await fixture<SlInput>(html` <gd-input value="test"></gd-input> `);
  ...
  runFormControlBaseTests('gd-input');
});
