 ...
 * @documentation https://disc.gsfc.nasa.gov/components/include
 * @status stable
 * @since 2.0
 *
 * @event gd-load - Emitted when the included file is loaded.
 * @event {{ status: number }} gd-error - Emitted when the included file fails to load due to an error.
 */
export default class SlInclude extends GDElement {
