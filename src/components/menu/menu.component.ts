 ...
 * @documentation https://disc.gsfc.nasa.gov/components/menu
 * @status stable
 * @since 2.0
 *
 * @slot - The menu's content, including menu items, menu labels, and dividers.
 *
 * @event {{ item: SlMenuItem }} gd-select - Emitted when a menu item is selected.
 */
export default class SlMenu extends GDElement {
  ...
  private isMenuItem(item: HTMLElement) {
    return (
      item.tagName.toLowerCase() === 'gd-menu-item' ||
