 ...
 * @documentation https://disc.gsfc.nasa.gov/components/copy
 * @status experimental
 * @since 2.7
 *
 * @dependency gd-icon
 * @dependency gd-tooltip
 *
 * @event gd-copy - Emitted when the data has been copied.
 * @event gd-error - Emitted when the data could not be copied.
 *
 * @slot copy-icon - The icon to show in the default copy state. Works best with `<gd-icon>`.
 * @slot success-icon - The icon to show when the content is copied. Works best with `<gd-icon>`.
 * @slot error-icon - The icon to show when a copy error occurs. Works best with `<gd-icon>`.
 *
 ...
 */
export default class SlCopyButton extends GDElement {
  ...
  @query('gd-tooltip') tooltip: SlTooltip;
      ...
      >
        ...
        >
          <slot part="copy-icon" name="copy-icon">
            <gd-icon library="system" name="copy"></gd-icon>
          </slot>
          <slot part="success-icon" name="success-icon" hidden>
            <gd-icon library="system" name="check"></gd-icon>
          </slot>
          <slot part="error-icon" name="error-icon" hidden>
            <gd-icon library="system" name="x-lg"></gd-icon>
          </slot>
        </button>
      </gd-tooltip>
    `;
