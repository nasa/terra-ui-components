...
export default css`
  :host {
    --thumb-size: 20px;
    --tooltip-offset: 10px;
    --track-color-active: var(--gd-color-neutral-200);
    --track-color-inactive: var(--gd-color-neutral-200);
  ...
  .range__control {
    ...
    line-height: var(--gd-input-height-medium);
  ...
  .range__control::-webkit-slider-thumb {
    ...
    border: solid var(--gd-input-border-width) var(--gd-color-primary-600);
    -webkit-appearance: none;
  ...
  .range__tooltip {
    ...
    transition: var(--gd-transition-fast) opacity;
    pointer-events: none;
  }
  ...
  .range__tooltip:after {
    ...
    height: 0;
    left: 50%;
    translate: calc(-1 * var(--gd-tooltip-arrow-size));
  }
  ...
  .range--tooltip-top .range__tooltip:after {
    border-top: var(--gd-tooltip-arrow-size) solid var(--gd-tooltip-background-color);
    border-left: var(--gd-tooltip-arrow-size) solid transparent;
    border-right: var(--gd-tooltip-arrow-size) solid transparent;
    top: 100%;
  }
  ...
  .range--tooltip-bottom .range__tooltip:after {
    border-bottom: var(--gd-tooltip-arrow-size) solid var(--gd-tooltip-background-color);
    border-left: var(--gd-tooltip-arrow-size) solid transparent;
    border-right: var(--gd-tooltip-arrow-size) solid transparent;
    bottom: 100%;
  }
