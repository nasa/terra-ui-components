...
describe('<gd-textarea>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<SlTextarea>(html` <gd-textarea label="Name"></gd-textarea> `);
    await expect(el).to.be.accessible();
  });

  it('default properties', async () => {
    const el = await fixture<SlTextarea>(html` <gd-textarea></gd-textarea> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<SlTextarea>(html` <gd-textarea title="Test"></gd-textarea> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<SlTextarea>(html` <gd-textarea disabled></gd-textarea> `);
  ...
  describe('when the value changes', () => {
    it('should emit gd-change and gd-input when the user types in the textarea', async () => {
      const el = await fixture<SlTextarea>(html` <gd-textarea></gd-textarea> `);
    ...
    it('should not emit gd-change or gd-input when calling setRangeText()', async () => {
      const el = await fixture<SlTextarea>(html` <gd-textarea value="hi there"></gd-textarea> `);
  ...
  describe('when using constraint validation', () => {
    ...
    it('should be invalid when required and empty', async () => {
      const el = await fixture<SlTextarea>(html` <gd-textarea required></gd-textarea> `);

      expect(el.checkValidity()).to.be.false;
    });

    it('should be invalid when required and after removing disabled ', async () => {
      const el = await fixture<SlTextarea>(html` <gd-textarea disabled required></gd-textarea> `);
    ...
    it('should receive the correct validation attributes ("states") when valid', async () => {
      const el = await fixture<SlTextarea>(html` <gd-textarea required value="a"></gd-textarea> `);
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      const el = await fixture<HTMLFormElement>(html` <form novalidate><gd-textarea required></gd-textarea></form> `);
      const textarea = el.querySelector<SlTextarea>('gd-textarea')!;
  ...
  describe('when submitting a form', () => {
    it('should serialize its name and value with FormData', async () => {
      const form = await fixture<HTMLFormElement>(html` <form><gd-textarea name="a" value="1"></gd-textarea></form> `);
    ...
    it('should be invalid when setCustomValidity() is called with a non-empty value', async () => {
      const textarea = await fixture<HTMLFormElement>(html` <gd-textarea></gd-textarea> `);
    ...
    it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <gd-textarea form="f" name="a" value="1"></gd-textarea>
        </div>
      `);
  ...
  describe('when resetting a form', () => {
    it('should reset the element to its initial value', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <gd-textarea name="a" value="test"></gd-textarea>
          <gd-button type="reset">Reset</gd-button>
        </form>
      `);
      const button = form.querySelector('gd-button')!;
      const textarea = form.querySelector('gd-textarea')!;
      textarea.value = '1234';
  ...
  describe('when using spellcheck', () => {
    ...
    it('should enable spellcheck when set to "true"', async () => {
      const el = await fixture<SlTextarea>(html` <gd-textarea spellcheck="true"></gd-textarea> `);
      const textarea = el.shadowRoot!.querySelector<HTMLTextAreaElement>('textarea')!;
      expect(textarea.getAttribute('spellcheck')).to.equal('true');
      expect(textarea.spellcheck).to.be.true;
    });
    ...
    it('should disable spellcheck when set to "false"', async () => {
      const el = await fixture<SlTextarea>(html` <gd-textarea spellcheck="false"></gd-textarea> `);
      const textarea = el.shadowRoot!.querySelector<HTMLTextAreaElement>('textarea')!;
  ...
  describe('when using the setRangeText() function', () => {
    it('should set replacement text in the correct location', async () => {
      const el = await fixture<SlTextarea>(html` <gd-textarea value="test"></gd-textarea> `);
  ...
  runFormControlBaseTests('gd-textarea');
});
