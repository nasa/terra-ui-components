...
describe('<gd-carousel>', () => {
  ...
  it('should render a carousel with default configuration', async () => {
    ...
    const el = await fixture(html`
      <gd-carousel>
        <gd-carousel-item>Node 1</gd-carousel-item>
        <gd-carousel-item>Node 2</gd-carousel-item>
        <gd-carousel-item>Node 3</gd-carousel-item>
      </gd-carousel>
    `);
  ...
  describe('when `autoplay` attribute is provided', () => {
    ...
    it('should scroll forwards every `autoplay-interval` milliseconds', async () => {
      ...
      const el = await fixture<SlCarousel>(html`
        <gd-carousel autoplay autoplay-interval="10">
          <gd-carousel-item>Node 1</gd-carousel-item>
          <gd-carousel-item>Node 2</gd-carousel-item>
          <gd-carousel-item>Node 3</gd-carousel-item>
        </gd-carousel>
  ...
  describe('when `loop` attribute is provided', () => {
    ...
    describe('and `slides-per-page` is provided', () => {
      it('should create multiple clones', async () => {
        // Arrange
        const el = await fixture<SlCarousel>(html`
          <gd-carousel loop slides-per-page="2">
            <gd-carousel-item>Node 1</gd-carousel-item>
            <gd-carousel-item>Node 2</gd-carousel-item>
            <gd-carousel-item>Node 3</gd-carousel-item>
          </gd-carousel>
      ...
      it(`should display ${expected} pages for ${slides} slides grouped by ${slidesPerPage} and scrolled by ${slidesPerMove}${
        ...
        const el = await fixture<SlCarousel>(html`
          <gd-carousel
            ...
            ?loop=${loop}
          >
            ${map(range(slides), i => html`<gd-carousel-item>${i}</gd-carousel-item>`)}
          </gd-carousel>
        `);
  ...
  describe('when `slides-per-move` attribute is provided', () => {
    it('should set the granularity of snapping', async () => {
      ...
      const el = await fixture<SlCarousel>(html`
        <gd-carousel slides-per-page="${expectedSnapGranularity}" slides-per-move="${expectedSnapGranularity}">
          <gd-carousel-item>Node 1</gd-carousel-item>
          <gd-carousel-item>Node 2</gd-carousel-item>
          <gd-carousel-item>Node 3</gd-carousel-item>
          <gd-carousel-item>Node 4</gd-carousel-item>
        </gd-carousel>
      `);
    ...
    it('should be possible to move by the given number of slides at a time', async () => {
      // Arrange
      const el = await fixture<SlCarousel>(html`
        <gd-carousel navigation slides-per-move="2" slides-per-page="2">
          <gd-carousel-item>Node 1</gd-carousel-item>
          <gd-carousel-item>Node 2</gd-carousel-item>
          <gd-carousel-item class="expected">Node 3</gd-carousel-item>
          <gd-carousel-item class="expected">Node 4</gd-carousel-item>
          <gd-carousel-item>Node 5</gd-carousel-item>
          <gd-carousel-item>Node 6</gd-carousel-item>
        </gd-carousel>
      `);
    ...
    it('should be possible to move by a number that is less than the displayed number', async () => {
      // Arrange
      const el = await fixture<SlCarousel>(html`
        <gd-carousel navigation slides-per-move="1" slides-per-page="2">
          <gd-carousel-item>Node 1</gd-carousel-item>
          <gd-carousel-item>Node 2</gd-carousel-item>
          <gd-carousel-item>Node 3</gd-carousel-item>
          <gd-carousel-item>Node 4</gd-carousel-item>
          <gd-carousel-item class="expected">Node 5</gd-carousel-item>
          <gd-carousel-item class="expected">Node 6</gd-carousel-item>
        </gd-carousel>
      `);
      const expectedSlides = el.querySelectorAll('.expected')!;
      const nextButton: HTMLElement = el.shadowRoot!.querySelector('.carousel__navigation-button--next')!;
    ...
    it('should not be possible to move by a number that is greater than the displayed number', async () => {
      ...
      const el = await fixture<SlCarousel>(html`
        <gd-carousel slides-per-page="${expectedSlidesPerMove}">
          <gd-carousel-item>Node 1</gd-carousel-item>
          <gd-carousel-item>Node 2</gd-carousel-item>
          <gd-carousel-item>Node 3</gd-carousel-item>
          <gd-carousel-item>Node 4</gd-carousel-item>
  ...
  describe('when `orientation` attribute is provided', () => {
    describe('and value is `vertical`', () => {
      it('should make the scrollable along the y-axis', async () => {
        // Arrange
        const el = await fixture<SlCarousel>(html`
          <gd-carousel orientation="vertical" style="height: 100px">
            <gd-carousel-item>Node 1</gd-carousel-item>
            <gd-carousel-item>Node 2</gd-carousel-item>
          </gd-carousel>
        `);
    ...
    describe('and value is `horizontal`', () => {
      it('should make the scrollable along the x-axis', async () => {
        // Arrange
        const el = await fixture<SlCarousel>(html`
          <gd-carousel orientation="horizontal" style="height: 100px">
            <gd-carousel-item>Node 1</gd-carousel-item>
            <gd-carousel-item>Node 2</gd-carousel-item>
          </gd-carousel>
        `);
  ...
  describe('when `mouse-dragging` attribute is provided', () => {
    ...
    it('should be possible to interact with clickable elements', async () => {
      ...
      const el = await fixture<SlCarousel>(html`
        <gd-carousel mouse-dragging>
          <gd-carousel-item><button>click me</button></gd-carousel-item>
          <gd-carousel-item>Node 2</gd-carousel-item>
          <gd-carousel-item>Node 3</gd-carousel-item>
        </gd-carousel>
      `);
  ...
  describe('API', () => {
    describe('#next', () => {
      it('should scroll the carousel to the next slide', async () => {
        ...
        const expectedCarouselItem: HTMLElement = el.querySelector('gd-carousel-item:nth-child(2)')!;
    ...
    describe('#previous', () => {
      it('should scroll the carousel to the previous slide', async () => {
        ...
        `);
        const expectedCarouselItem: HTMLElement = el.querySelector('gd-carousel-item:nth-child(1)')!;
  ...
  describe('Accessibility', () => {
    it('should pass accessibility tests', async () => {
      // Arrange
      const el = await fixture<SlCarousel>(html`
        <gd-carousel navigation pagination>
          <gd-carousel-item>Node 1</gd-carousel-item>
          <gd-carousel-item>Node 2</gd-carousel-item>
          <gd-carousel-item>Node 3</gd-carousel-item>
        </gd-carousel>
