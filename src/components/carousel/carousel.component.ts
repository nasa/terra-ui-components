 ...
 * @dependency gd-icon
 *
 * @event {{ index: number, slide: SlCarouselItem }} gd-slide-change - Emitted when the active slide changes.
 *
 * @slot - The carousel's main content, one or more `<gd-carousel-item>` elements.
 * @slot next-icon - Optional next icon to use instead of the default. Works best with `<gd-icon>`.
 * @slot previous-icon - Optional previous icon to use instead of the default. Works best with `<gd-icon>`.
 *
 ...
 */
export default class SlCarousel extends GDElement {
  ...
  private isCarouselItem(node: Node): node is SlCarouselItem {
    return node instanceof Element && node.tagName.toLowerCase() === 'gd-carousel-item';
  }
              ...
              <div part="navigation" class="carousel__navigation">
                ...
                >
                  <slot name="previous-icon">
                    <gd-icon library="system" name="${isLtr ? 'chevron-left' : 'chevron-right'}"></gd-icon>
                  </slot>
                </button>
                ...
                >
                  <slot name="next-icon">
                    <gd-icon library="system" name="${isLtr ? 'chevron-right' : 'chevron-left'}"></gd-icon>
                  </slot>
                </button>
              </div>
            `
