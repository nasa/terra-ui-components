 ...
 * @documentation https://disc.gsfc.nasa.gov/components/tree
 * @status stable
 * @since 2.0
 *
 * @event {{ selection: SlTreeItem[] }} gd-selection-change - Emitted when a tree item is selected or deselected.
 *
 * @slot - The default slot.
 * @slot expand-icon - The icon to show when the tree item is expanded. Works best with `<gd-icon>`.
 * @slot collapse-icon - The icon to show when the tree item is collapsed. Works best with `<gd-icon>`.
 *
 * @csspart base - The component's base wrapper.
 *
 * @cssproperty [--indent-size=var(--gd-spacing-medium)] - The size of the indentation for nested items.
 * @cssproperty [--indent-guide-color=var(--gd-color-neutral-200)] - The color of the indentation line.
 * @cssproperty [--indent-guide-offset=0] - The amount of vertical spacing to leave between the top and bottom of the
 *  indentation line's starting position.
 * @cssproperty [--indent-guide-style=solid] - The style of the indentation line, e.g. solid, dotted, dashed.
 * @cssproperty [--indent-guide-width=0] - The width of the indentation line.
 */
export default class SlTree extends GDElement {
  ...
  constructor() {
    ...
    this.addEventListener('gd-lazy-change', this.handleSlotChange);
  }
  ...
  private getAllTreeItems() {
    return [...this.querySelectorAll<SlTreeItem>('gd-tree-item')];
  }
  ...
  private handleClick(event: Event) {
    ...
    const treeItem = target.closest('gd-tree-item')!;
    ...
    //
    // See https://github.com/gesdisc/components/issues/1082
    //
  ...
  async handleSelectionChange() {
    ...
    if (isSelectionMultiple) {
      ...
      [...this.querySelectorAll(':scope > gd-tree-item')].forEach((treeItem: SlTreeItem) =>
