...
describe('<gd-tag>', () => {
  it('should render default tag', async () => {
    const el = await fixture<SlTag>(html` <gd-tag>Test</gd-tag> `);
  ...
  it('should set variant by attribute', async () => {
    const el = await fixture<SlTag>(html` <gd-tag variant="danger">Test</gd-tag> `);
  ...
  it('should set size by attribute', async () => {
    const el = await fixture<SlTag>(html` <gd-tag size="large">Test</gd-tag> `);
  ...
  it('should set pill-attribute by attribute', async () => {
    const el = await fixture<SlTag>(html` <gd-tag pill>Test</gd-tag> `);
  ...
  it('should set removable by attribute', async () => {
    const el = await fixture<SlTag>(html` <gd-tag removable>Test</gd-tag> `);
  ...
  describe('removable', () => {
    it('should emit remove event when remove button clicked', async () => {
      ...
      el.addEventListener('gd-remove', spy, { once: true });
