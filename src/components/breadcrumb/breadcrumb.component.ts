 ...
 *
 * @cssproperty --terra-breadcrumb-text-default - The text color of inactive breadcrumbs.
 * @cssproperty --terra-breadcrumb-text-current - The text color of the current (last) breadcrumb.
 * @cssproperty --terra-breadcrumb-text-visited - The text color of visited breadcrumb links.
 */
