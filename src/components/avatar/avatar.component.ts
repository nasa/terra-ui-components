 ...
 * @dependency gd-icon
 *
 * @slot icon - The default icon to use when no image or initials are present. Works best with `<gd-icon>`.
 *
 ...
 */
export default class SlAvatar extends GDElement {
    ...
    if (this.initials) {
      ...
      avatarWithoutImage = html`
        <div part="icon" class="avatar__icon" aria-hidden="true">
          <slot name="icon">
            <gd-icon name="person-fill" library="system"></gd-icon>
          </slot>
        </div>
      `;
    }
