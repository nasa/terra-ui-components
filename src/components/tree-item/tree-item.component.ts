 ...
 * @documentation https://disc.gsfc.nasa.gov/components/tree-item
 * @status stable
 * @since 2.0
 *
 * @dependency gd-checkbox
 * @dependency gd-icon
 * @dependency gd-spinner
 *
 * @event gd-expand - Emitted when the tree item expands.
 * @event gd-after-expand - Emitted after the tree item expands and all animations are complete.
 * @event gd-collapse - Emitted when the tree item collapses.
 * @event gd-after-collapse - Emitted after the tree item collapses and all animations are complete.
 * @event gd-lazy-change - Emitted when the tree item's lazy state changes.
 * @event gd-lazy-load - Emitted when a lazy item is selected. Use this event to asynchronously load data and append
 ...
 */
export default class SlTreeItem extends GDElement {
      ...
      >
        ...
        >
          ...
          >
            ${when(
              this.loading,
              () => html` <gd-spinner part="spinner" exportparts="base:spinner__base"></gd-spinner> `
            )}
            <slot class="tree-item__expand-icon-slot" name="expand-icon">
              <gd-icon library="system" name=${isRtl ? 'chevron-left' : 'chevron-right'}></gd-icon>
            </slot>
