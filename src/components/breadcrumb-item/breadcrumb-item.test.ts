...
describe('<gd-breadcrumb-item>', () => {
  let el: SlBreadcrumbItem;

  describe('when not provided a href attribute', () => {
    before(async () => {
      el = await fixture<SlBreadcrumbItem>(html` <gd-breadcrumb-item>Home</gd-breadcrumb-item> `);
    });
  ...
  describe('when provided a href attribute', () => {
    describe('and no target', () => {
      before(async () => {
        el = await fixture<SlBreadcrumbItem>(html`
          <gd-breadcrumb-item href="https://jsonplaceholder.typicode.com/">Home</gd-breadcrumb-item>
        `);
      });
    ...
    describe('and target, without rel', () => {
      before(async () => {
        el = await fixture<SlBreadcrumbItem>(html`
          <gd-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank">Help</gd-breadcrumb-item>
        `);
      });
    ...
    describe('and target, with rel', () => {
      before(async () => {
        el = await fixture<SlBreadcrumbItem>(html`
          <gd-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank" rel="alternate"
            >Help</gd-breadcrumb-item
          >
        `);
      });
