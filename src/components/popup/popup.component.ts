 ...
 * @since 2.0
 *
 * @event gd-reposition - Emitted when the popup is repositioned. This event can fire a lot, so avoid putting expensive
 ...
 *  attribute is used.
 * @cssproperty [--arrow-color=var(--gd-color-neutral-0)] - The color of the arrow.
 ...
 *  available when using `auto-size`.
 */
export default class SlPopup extends GDElement {
  ...
  reposition() {
    ...
    //
    // More info: https://github.com/gesdisc/components/issues/1135
    //
