...
describe('<gd-option>', () => {
  it('passes accessibility test', async () => {
    const el = await fixture<SlOption>(html`
      <gd-select label="Select one">
        <gd-option value="1">Option 1</gd-option>
        <gd-option value="2">Option 2</gd-option>
        <gd-option value="3">Option 3</gd-option>
        <gd-option value="4" disabled>Disabled</gd-option>
      </gd-select>
    `);
  ...
  it('default properties', async () => {
    const el = await fixture<SlOption>(html` <gd-option>Test</gd-option> `);
  ...
  it('emits the slotchange event when the label changes', async () => {
    const el = await fixture<SlOption>(html` <gd-option>Text</gd-option> `);
  ...
  it('should escape HTML when calling getTextLabel()', async () => {
    const el = await fixture<SlOption>(html` <gd-option><strong>Option</strong></gd-option> `);
