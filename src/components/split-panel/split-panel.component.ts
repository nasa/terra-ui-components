 ...
 * @documentation https://disc.gsfc.nasa.gov/components/split-panel
 * @status stable
 * @since 2.0
 *
 * @event gd-reposition - Emitted when the divider's position changes.
 *
 ...
 */
export default class SlSplitPanel extends GDElement {
