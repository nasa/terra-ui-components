...
describe('<gd-checkbox>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<SlCheckbox>(html` <gd-checkbox>Checkbox</gd-checkbox> `);
    await expect(el).to.be.accessible();
  });

  it('default properties', async () => {
    const el = await fixture<SlCheckbox>(html` <gd-checkbox></gd-checkbox> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<SlCheckbox>(html` <gd-checkbox title="Test"></gd-checkbox> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<SlCheckbox>(html` <gd-checkbox disabled></gd-checkbox> `);
  ...
  it('should not emit gd-change or gd-input when checked programmatically', async () => {
    const el = await fixture<SlCheckbox>(html` <gd-checkbox></gd-checkbox> `);
  ...
  describe('when submitting a form', () => {
    it('should submit the correct value when a value is provided', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <gd-checkbox name="a" value="1" checked></gd-checkbox>
    ...
    it('should submit "on" when no value is provided', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <gd-checkbox name="a" checked></gd-checkbox>
          <gd-button type="submit">Submit</gd-button>
        </form>
      `);
      const button = form.querySelector('gd-button')!;
    ...
    it('should be invalid when setCustomValidity() is called with a non-empty value', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <gd-checkbox></gd-checkbox> `);
    ...
    it('should be invalid when required and unchecked', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <gd-checkbox required></gd-checkbox> `);
      expect(checkbox.checkValidity()).to.be.false;
    });

    it('should be valid when required and checked', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <gd-checkbox required checked></gd-checkbox> `);
    ...
    it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <gd-checkbox form="f" name="a" value="1" checked></gd-checkbox>
        </div>
      `);
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      const el = await fixture<HTMLFormElement>(html` <form novalidate><gd-checkbox required></gd-checkbox></form> `);
      const checkbox = el.querySelector<SlCheckbox>('gd-checkbox')!;
  ...
  describe('focus', () => {
    ...
    it('should not jump the page to the bottom when focusing a checkbox at the bottom of an element with overflow: auto;', async () => {
      ...
      const checkboxes = el.querySelectorAll<SlCheckbox>('gd-checkbox');
  ...
  describe('indeterminate', () => {
    it('should render indeterminate icon until checked', async () => {
      const el = await fixture<SlCheckbox>(html`<gd-checkbox indeterminate></gd-checkbox>`);
    ...
    runFormControlBaseTests('gd-checkbox');
  });
});
