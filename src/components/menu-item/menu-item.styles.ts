...
export default css`
  ...
  .menu-item {
    ...
    padding: var(--gd-spacing-2x-small) var(--gd-spacing-2x-small);
  ...
  .menu-item.menu-item--loading *:not(gd-spinner) {
    opacity: 0.5;
  }

  .menu-item--loading gd-spinner {
  ...
  .menu-item--submenu-expanded::after {
    content: '';
    position: fixed;
    z-index: calc(var(--gd-z-index-dropdown) - 1);
    top: 0;
    right: 0;
    bottom: 0;
    left: 0;
  ...
  .menu-item--rtl gd-popup::part(popup) {
