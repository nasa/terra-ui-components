 ...
 * @documentation https://disc.gsfc.nasa.gov/components/menu-item
 * @status stable
 * @since 2.0
 *
 * @dependency gd-icon
 ...
 */
export default class SlMenuItem extends GDElement {
    ...
    return html`
      ...
      >
        <span part="checked-icon" class="menu-item__check">
          <gd-icon name="check" library="system" aria-hidden="true"></gd-icon>
        </span>
        ...
        <span part="submenu-icon" class="menu-item__chevron">
          <gd-icon name=${isRtl ? 'chevron-left' : 'chevron-right'} library="system" aria-hidden="true"></gd-icon>
        </span>

        ${this.submenuController.renderSubmenu()}
        ${this.loading ? html` <gd-spinner part="spinner" exportparts="base:spinner__base"></gd-spinner> ` : ''}
      </div>
    `;
  }
}
