...
//
export const formCollections: WeakMap<HTMLFormElement, Set<GDFormControl>> = new WeakMap();
...
export class FormControlController implements ReactiveController {
  ...
  constructor(host: ReactiveControllerHost & GDFormControl, options?: Partial<FormControlControllerOptions>) {
  ...
  private detachForm() {
    ...
    // see: https://github.com/gesdisc/components/issues/1703
  ...
  setValidity(isValid: boolean) {
    ...
    //
    // See this RFC for more details: https://github.com/gesdisc/components/issues/1011
    //
  ...
  emitInvalidEvent(originalInvalidEvent?: Event) {
    const slInvalidEvent = new CustomEvent<Record<PropertyKey, never>>('gd-invalid', {
      bubbles: false,
      composed: false,
      cancelable: true,
      detail: {}
