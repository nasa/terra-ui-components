...
export default class GDElement extends LitElement {
  ...
  static define(name: string, elementConstructor = this, options: ElementDefinitionOptions = {}) {
    const currentlyRegisteredConstructor = customElements.get(name) as CustomElementConstructor | typeof GDElement;
  ...
  constructor() {
    super();
    Object.entries((this.constructor as typeof GDElement).dependencies).forEach(([name, component]) => {
