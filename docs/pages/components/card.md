...
<gd-card class="card-overview">
  ...
  <div slot="footer">
    <gd-button variant="primary" pill>More Info</gd-button>
    <gd-rating></gd-rating>
  </div>
</gd-card>
...
import SlCard from '@gesdisc/components/dist/react/card';
...
```html:preview
<gd-card class="card-footer">
  This card has a footer. You can put all sorts of things in it!

  <div slot="footer">
    <gd-rating></gd-rating>
    <gd-button variant="primary">Preview</gd-button>
  </div>
</gd-card>
