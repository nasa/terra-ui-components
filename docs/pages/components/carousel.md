...
```html:preview
<gd-carousel pagination navigation mouse-dragging loop>
  <gd-carousel-item>
    <img
...
```jsx:react
import SlCarousel from '@gesdisc/components/dist/react/carousel';
import SlCarouselItem from '@gesdisc/components/dist/react/carousel-item';
...
```html:preview
<gd-carousel loop navigation pagination>
  <gd-carousel-item>
    <img
      alt="The sun shines on the mountains and trees (by Adam Kool on Unsplash)"
      src="/assets/examples/carousel/mountains.jpg"
...
```html:preview
<gd-carousel autoplay loop pagination>
  <gd-carousel-item>
    <img
      alt="The sun shines on the mountains and trees (by Adam Kool on Unsplash)"
      src="/assets/examples/carousel/mountains.jpg"
...
<div class="mouse-dragging">
  ...
  <gd-switch>Enable mouse dragging</gd-switch>
</div>

<script>
  const container = document.querySelector('.mouse-dragging');
  const carousel = container.querySelector('gd-carousel');
  const toggle = container.querySelector('gd-switch');

  toggle.addEventListener('gd-change', () => {
...
```html:preview
<gd-carousel navigation pagination slides-per-page="2" slides-per-move="2">
  <gd-carousel-item style="background: var(--gd-color-red-200);">Slide 1</gd-carousel-item>
  <gd-carousel-item style="background: var(--gd-color-orange-200);">Slide 2</gd-carousel-item>
  <gd-carousel-item style="background: var(--gd-color-yellow-200);">Slide 3</gd-carousel-item>
  <gd-carousel-item style="background: var(--gd-color-green-200);">Slide 4</gd-carousel-item>
  <gd-carousel-item style="background: var(--gd-color-blue-200);">Slide 5</gd-carousel-item>
  <gd-carousel-item style="background: var(--gd-color-violet-200);">Slide 6</gd-carousel-item>
</gd-carousel>
```
...
const App = () => (
  <SlCarousel navigation pagination slidesPerPage={2} slidesPerMove={2}>
    <SlCarouselItem style={{ background: 'var(--gd-color-red-200)' }}>Slide 1</SlCarouselItem>
    <SlCarouselItem style={{ background: 'var(--gd-color-orange-200)' }}>Slide 2</SlCarouselItem>
    <SlCarouselItem style={{ background: 'var(--gd-color-yellow-200)' }}>Slide 3</SlCarouselItem>
    <SlCarouselItem style={{ background: 'var(--gd-color-green-200)' }}>Slide 4</SlCarouselItem>
    <SlCarouselItem style={{ background: 'var(--gd-color-blue-200)' }}>Slide 5</SlCarouselItem>
    <SlCarouselItem style={{ background: 'var(--gd-color-violet-200)' }}>Slide 6</SlCarouselItem>
  </SlCarousel>
);
```
...
```html:preview
<gd-carousel class="dynamic-carousel" pagination navigation>
  <gd-carousel-item style="background: var(--gd-color-red-200)">Slide 1</gd-carousel-item>
  <gd-carousel-item style="background: var(--gd-color-orange-200)">Slide 2</gd-carousel-item>
  <gd-carousel-item style="background: var(--gd-color-yellow-200)">Slide 3</gd-carousel-item>
</gd-carousel>
...
<div class="carousel-options">
  <gd-button id="dynamic-add">Add slide</gd-button>
  <gd-button id="dynamic-remove">Remove slide</gd-button>
</div>
...
<style>
  ...
  .dynamic-carousel ~ .carousel-options {
    ...
    gap: var(--gd-spacing-x-small);
    margin-top: var(--gd-spacing-large);
  }

  .dynamic-carousel gd-carousel-item {
    flex: 0 0 100%;
    display: flex;
    align-items: center;
    justify-content: center;
    font-size: var(--gd-font-size-2x-large);
  }
</style>
...
<script>
  (() => {
    ...
    const addSlide = () => {
      const slide = document.createElement('gd-carousel-item');
      const color = colors[++colorIndex % colors.length];
      slide.innerText = `Slide ${dynamicCarousel.children.length + 1}`;
      slide.style.setProperty('background', `var(--gd-color-${color}-200)`);
    ...
    const removeSlide = () => {
      ...
      const numSlides = dynamicCarousel.querySelectorAll('gd-carousel-item').length;
...
```html:preview
<gd-carousel class="vertical" pagination orientation="vertical">
  <gd-carousel-item>
    <img
      alt="The sun shines on the mountains and trees (by Adam Kool on Unsplash)"
      src="/assets/examples/carousel/mountains.jpg"
...
```html:preview
<gd-carousel class="aspect-ratio" navigation pagination style="--aspect-ratio: 3/2;">
  <gd-carousel-item>
    <img
      alt="The sun shines on the mountains and trees (by Adam Kool on Unsplash)"
      src="/assets/examples/carousel/mountains.jpg"
...
<gd-select label="Aspect ratio" name="aspect" value="3/2">
  <gd-option value="1/1">1/1</gd-option>
  <gd-option value="3/2">3/2</gd-option>
  <gd-option value="16/9">16/9</gd-option>
</gd-select>

<script>
  (() => {
    const carousel = document.querySelector('gd-carousel.aspect-ratio');
    const aspectRatio = document.querySelector('gd-select[name="aspect"]');

    aspectRatio.addEventListener('gd-change', () => {
...
```html:preview
<gd-carousel class="scroll-hint" pagination style="--scroll-hint: 10%;">
  <gd-carousel-item>
    <img
      alt="The sun shines on the mountains and trees (by Adam Kool on Unsplash)"
      src="/assets/examples/carousel/mountains.jpg"
...
```html:preview
<gd-carousel class="carousel-thumbnails" navigation loop>
  <gd-carousel-item>
    <img
      alt="The sun shines on the mountains and trees (by Adam Kool on Unsplash)"
      src="/assets/examples/carousel/mountains.jpg"
...
<style>
  ...
  .thumbnails__scroller {
    display: flex;
    gap: var(--gd-spacing-small);
    overflow-x: auto;
    scrollbar-width: none;
    scroll-behavior: smooth;
    scroll-padding: var(--gd-spacing-small);
  }
...
<script>
  {
    ...
    carousel.addEventListener('gd-slide-change', e => {
