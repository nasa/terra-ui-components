...
```js
import { setDefaultAnimation } from '@nasa/terra-ui-components/dist/utilities/animation-registry.js'
...
```js
import { setAnimation } from '@nasa/terra-ui-components/dist/utilities/animation-registry.js'
