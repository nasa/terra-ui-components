...
To make a field required, use the `required` attribute. Required fields will automatically receive a `*` after their labels. This is configurable through the `--gd-input-required-content` custom property.
...
<script type="module">
  ...
  await Promise.all([
    ...
    customElements.whenDefined('gd-checkbox'),
    customElements.whenDefined('gd-input'),
    customElements.whenDefined('gd-option'),
    customElements.whenDefined('gd-select'),
    customElements.whenDefined('gd-textarea')
  ]).then(() => {
...
<style>
  .validity-styles gd-input,
  .validity-styles gd-select,
  .validity-styles gd-checkbox {
    display: block;
    margin-bottom: var(--gd-spacing-medium);
  }

  /* user invalid styles */
  .validity-styles gd-input[data-user-invalid]::part(base),
  .validity-styles gd-select[data-user-invalid]::part(combobox),
  .validity-styles gd-checkbox[data-user-invalid]::part(control) {
    border-color: var(--gd-color-danger-600);
  }

  .validity-styles [data-user-invalid]::part(form-control-label),
  .validity-styles [data-user-invalid]::part(form-control-help-text),
  .validity-styles gd-checkbox[data-user-invalid]::part(label) {
    color: var(--gd-color-danger-700);
  }
  ...
  .validity-styles gd-input:focus-within[data-user-invalid]::part(base),
  .validity-styles gd-select:focus-within[data-user-invalid]::part(combobox),
  .validity-styles gd-checkbox:focus-within[data-user-invalid]::part(control) {
    border-color: var(--gd-color-danger-600);
    box-shadow: 0 0 0 var(--gd-focus-ring-width) var(--gd-color-danger-300);
  }

  /* User valid styles */
  .validity-styles gd-input[data-user-valid]::part(base),
  .validity-styles gd-select[data-user-valid]::part(combobox),
  .validity-styles gd-checkbox[data-user-valid]::part(control) {
    border-color: var(--gd-color-success-600);
  }

  .validity-styles [data-user-valid]::part(form-control-label),
  .validity-styles [data-user-valid]::part(form-control-help-text),
  .validity-styles gd-checkbox[data-user-valid]::part(label) {
    color: var(--gd-color-success-700);
  }
  ...
  .validity-styles gd-input:focus-within[data-user-valid]::part(base),
  .validity-styles gd-select:focus-within[data-user-valid]::part(combobox),
  .validity-styles gd-checkbox:focus-within[data-user-valid]::part(control) {
    border-color: var(--gd-color-success-600);
    box-shadow: 0 0 0 var(--gd-focus-ring-width) var(--gd-color-success-300);
  }
</style>
```
...
To disable the browser's error messages, you need to cancel the `gd-invalid` event. Then you can apply your own inline validation errors. This example demonstrates a primitive way to do this.
...
<script type="module">
  ...
  await Promise.all([
    ...
    form.addEventListener(
      ...
      { capture: true } // you must use capture since gd-invalid doesn't bubble!
    );
...
<style>
  ...
  #name-error ~ gd-button {
    margin-top: var(--gd-spacing-medium);
  }

  .inline-validation gd-input {
    display: block;
  }

  /* user invalid styles */
  .inline-validation gd-input[data-user-invalid]::part(base) {
    border-color: var(--gd-color-danger-600);
  }
  ...
  .inline-validation gd-input:focus-within[data-user-invalid]::part(base) {
    border-color: var(--gd-color-danger-600);
    box-shadow: 0 0 0 var(--gd-focus-ring-width) var(--gd-color-danger-300);
  }

  /* User valid styles */
  .inline-validation gd-input[data-user-valid]::part(base) {
    border-color: var(--gd-color-success-600);
  }
  ...
  .inline-validation gd-input:focus-within[data-user-valid]::part(base) {
    border-color: var(--gd-color-success-600);
    box-shadow: 0 0 0 var(--gd-focus-ring-width) var(--gd-color-success-300);
  }
</style>
