...
```js
import { serialize } from '@nasa/terra-ui-components/dist/utilities/form.js'
...
import SlCheckbox from '@nasa/terra-ui-components/dist/react/checkbox';
import SlInput from '@nasa/terra-ui-components/dist/react/input';
import SlMenuItem from '@nasa/terra-ui-components/dist/react/menu-item';
import SlSelect from '@nasa/terra-ui-components/dist/react/select';
import SlTextarea from '@nasa/terra-ui-components/dist/react/textarea';
...
```js
import { getFormControls } from '@nasa/terra-ui-components/dist/utilities/form.js'
